        ...
        >
          <motion.div variants={fadeUp} className="flex items-center gap-2 mb-6">
            <span className="flex -space-x-1">
              {[...Array(4)].map((_, i) => (
                <span key={i} className="h-2 w-2 rounded-full bg-[var(--color-pine-300)]" />
              ))}
            </span>
            <span className="caption flex items-center gap-1">
              <Star size={13} className="fill-[var(--color-terracotta-500)] text-[var(--color-terracotta-500)]" />
              4.7/5 from 38,000+ assessments
            </span>
          </motion.div>

          <motion.h1 variants={fadeUp} className="h-display text-5xl md:text-6xl">
            Your hair fall has a <em className="italic text-[var(--color-pine-700)]">root cause.</em>
            <br />We find it before we treat it.
          </motion.h1>

          <motion.p variants={fadeUp} className="body-lead mt-6 max-w-lg">
            Hormones, nutrition, stress, and scalp health — most hair-care brands
            guess. ThriveRoots starts with a clinical-grade assessment, then
            builds a therapy plan around what&apos;s actually causing your shedding.
          </motion.p>
          ...
          <motion.p variants={fadeUp} className="caption mt-5">
            9-minute assessment · No payment required · Reviewed by dermatologists
          </motion.p>
        </motion.div>
        ...
        >
          <div className="relative w-full max-w-[420px] aspect-[4/5] rounded-[var(--radius-xl)] bg-[var(--color-pine-50)] border border-[var(--color-pine-100)] overflow-hidden">
            ...
            <div className="absolute bottom-6 left-6 right-6 card p-4 flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-[var(--color-ink-900)]">Hair Score: Improving</p>
